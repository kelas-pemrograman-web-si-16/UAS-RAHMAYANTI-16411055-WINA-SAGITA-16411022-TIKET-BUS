...
public class Registrasi extends AppCompatActivity {
    ...
    void register(){
        ...
        String namalengkaps= nama_lengkap.getText().toString();
        String telepon = tlpn.getText().toString();
        ...
        if(usernames.isEmpty()){
            ...
            register(usernames, namalengkaps,telepon,emails, pass);
        }
    }
    ...
    public void register(final String username, final String nama_lengkap, final String tlpn, final String email, final String password){
